...
public class Directory {
  //TODO: Complete JavaDocs and clean up comments
  ...
  // Removed these methods in Directory in order to not violate Single Responsibility Principle
  // These methods should be implemented where necessary in other classes
