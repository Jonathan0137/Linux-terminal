...
public class Verifier {
  /**
   * Check if user's command exist or not, if exist then return a instance of 
   * that command, if not,return null.
   * 
  ...
  public static Command checkUserInputCommand(String userInput) {
    ...
    else if(command.equals("cat")||command.equals("echo"))
    {
      return createFilesCommands(command, userInput);
        ...
        command.equals("exit")||command.equals("man"))
    {
   ...
   * if exist then return a instance of that command, 
   * if not,return null. Only for Other commands that are left 
   * such as history, exit and man.
   * 
  ...
  * @return             An instance of command of user's selected commands
  */
 private static Command createFilesCommands(String command, String userInput)
 {
   switch (command)
   {
     case "cat":
  ...
  * Helper method that check if user's command exist or not, 
  * if exist then return a instance of that command, 
  * if not,return null. Only for DirCommands 
  * such as cd, mkdir, pwd and ls
  * 
  * @param command      A String that represents the command to be created
  * @return             An instance of command of user's selected commands
  */
